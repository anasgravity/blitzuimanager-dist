...
const Lc = ln(() => import("./index-2480e504.js")), Dc = ln(() => import("./index-9c2291d1.js")), Ac = {
  type: "phone",
  empty: (n) => !n,
...
function Zr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-11c3d280.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-86a9f4a3.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-d0957962.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-c36e6f33.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-5ca76e6f.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-d7ed0fb7.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-0362d08e.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-2480e504.js")),
      boolean: as,
      date: Kt,
      html: ln(() => import("./index-9c2291d1.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Vr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-7d0a8f94.js")),
      varchar: vu,
      text: Qs,
      markdown: Qs,
      tag: Du,
      texti18n: Au,
      email: bu,
      phone: nt(() => import("./index-a8b2e4f7.js")),
      url: wu,
      youtube: Ou,
      int: Zs,
      tinyint: Zs,
...
const Sd = () => import("./BDComments-508c34ca.js").then((n) => n.f).then((n) => n.default), Md = "2.14.2";
