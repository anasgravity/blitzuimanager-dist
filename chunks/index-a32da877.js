...
const Lc = ln(() => import("./index-7c20a007.js")), Dc = ln(() => import("./index-01159dca.js")), Ac = {
  type: "phone",
  empty: (n) => !n,
...
function Zr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-0680d249.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-8f6e7f5c.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-8444a0f7.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-e49340f8.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-3ac28bd6.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-ea236d82.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-4356a0e7.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-7c20a007.js")),
      boolean: as,
      date: Kt,
      html: ln(() => import("./index-01159dca.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Vr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-3be177d0.js")),
      varchar: vu,
      text: Qs,
      markdown: Qs,
      tag: Du,
      texti18n: Au,
      email: bu,
      phone: nt(() => import("./index-86c1525f.js")),
      url: wu,
      youtube: Ou,
      int: Zs,
      tinyint: Zs,
...
const Sd = () => import("./BDComments-a402b3bc.js").then((n) => n.f).then((n) => n.default), Md = "2.14.4";
