...
const Lc = ln(() => import("./index-1b037988.js")), Dc = ln(() => import("./index-cefada54.js")), Ac = {
  type: "phone",
  empty: (n) => !n,
...
function Zr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-3db16f51.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-890ce4ad.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-1d9a1b5b.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-3c7d65f5.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-14185a21.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-7b6ff333.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-df8ba080.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-1b037988.js")),
      boolean: as,
      date: Kt,
      html: ln(() => import("./index-cefada54.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Vr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-9a171d14.js")),
      varchar: vu,
      text: Qs,
      markdown: Qs,
      tag: Du,
      texti18n: Au,
      email: bu,
      phone: nt(() => import("./index-a635c21c.js")),
      url: wu,
      youtube: Ou,
      int: Zs,
      tinyint: Zs,
...
const Sd = () => import("./BDComments-2c5df530.js").then((n) => n.f).then((n) => n.default), Md = "2.14.5";
