...
const Dc = ln(() => import("./index-53d98df3.js")), Ac = ln(() => import("./index-83755b0c.js")), Ic = {
  type: "phone",
  empty: (n) => !n,
...
function Gr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-a6c6e5e7.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-9bcc37cf.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-0762912d.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-403ecb1b.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-54a5f49a.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-50b88194.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-43052554.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-53d98df3.js")),
      boolean: as,
      date: Xt,
      html: ln(() => import("./index-83755b0c.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Yr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-63282791.js")),
      varchar: bu,
      text: Qs,
      markdown: Qs,
      tag: Au,
      texti18n: Iu,
      email: wu,
      phone: nt(() => import("./index-c4ca546f.js")),
      url: _u,
      youtube: zu,
      int: Zs,
      tinyint: Zs,
...
const Cd = () => import("./BDComments-03afff3b.js").then((n) => n.f).then((n) => n.default), xd = "2.14.7";
