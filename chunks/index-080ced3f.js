...
const Dc = ln(() => import("./index-7e146b7b.js")), Ac = ln(() => import("./index-20bbef63.js")), Ic = {
  type: "phone",
  empty: (n) => !n,
...
function Gr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-2351fe73.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-0c73c8df.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-d85adf67.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-c76ba62c.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-72f6d0d4.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-415f9c22.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-49985557.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-7e146b7b.js")),
      boolean: as,
      date: Xt,
      html: ln(() => import("./index-20bbef63.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Yr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-4ad2d3ae.js")),
      varchar: bu,
      text: Qs,
      markdown: Qs,
      tag: Au,
      texti18n: Iu,
      email: wu,
      phone: nt(() => import("./index-45eacd68.js")),
      url: _u,
      youtube: zu,
      int: Zs,
      tinyint: Zs,
...
const Cd = () => import("./BDComments-b1877e6d.js").then((n) => n.f).then((n) => n.default), xd = "2.14.9";
