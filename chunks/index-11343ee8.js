...
var ba = (n, e, t) => e in n ? va(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var ne = (n, e, t) => (ba(n, typeof e != "symbol" ? e + "" : e, t), t);
const wa = (n) => n == null || n === "" || Array.isArray(n) && n.length === 0, ur = (n) => Array.isArray(n) ? n[0] : n, bn = (n, e) => n.endsWith("_fk") ? "fk" : n.endsWith("_mtm") ? "mtm" : ur(e), vs = ["view", "control", "filter", "editor", "default", "empty"];
class _a {
  constructor(e) {
...
function vt(n) {
  return Array.isArray(n) ? n.map((e) => Bt(e)) : [];
}
function Ht(n) {
  return n.replace(/(\^|\$|\\|\/|\||\*|\+|\-|\.|\?|\(|\)|\[|\]|\{|\})/g, "\\$&");
}
...
async function Xn(n, e, t) {
  if (await fr(t), !window.google || !window.google.maps)
    return null;
...
const Ma = new Function("url", "return import(url)");
async function Ca(n, e = Ma) {
...
function hr(n) {
  ...
  return e.length === 0 ? null : (t) => e.every((s) => {
    var r;
    return xa((r = t[s]) == null ? void 0 : r.value, n[s]);
  });
}
const ws = (n) => n.map(
...
function xa(n, e) {
  switch (e.op) {
    case "contains":
      return typeof n == "string" && !!n.match(new RegExp(Ht(String(e.value)), "i"));
    case "eq":
...
function mr(n, e) {
  ...
  return e((r) => {
    ...
    s = !0, t || (t = document.createElement("span"), n.classList.add("bd-has-status"), n.append(t)), t.className = `bd-status-badge bd-status-${r.status}`, t.title = $a[r.status] ?? r.status;
...
class on {
   ...
   */
  attach(e, t) {
    this._destroyed || typeof (t == null ? void 0 : t.syncStatus) != "function" || this._stops.push(mr(e, (s) => t.syncStatus(s)));
  }
...
}, La = /* @__PURE__ */ new Set(["varchar", "text", "markdown", "email", "url", "tag", "hex", "formula", "youtube"]), _s = (n, e) => e && La.has(n) ? ka(e, "contains") : void 0, qt = (n) => typeof n == "function" ? n : () => {
};
class Da {
  constructor(e) {
    this.deps = e;
  ...
  async mount(e, t, s, r) {
    ...
    if (s === "read") {
      ...
      const u = () => {
        var h;
        return e.status && ((h = e.mountConfig) == null ? void 0 : h.status) !== !1 ? mr(t, e.status) : void 0;
      };
      if (typeof d == "string") {
        t.innerHTML = d;
        const h = u();
    ...
    if (!o) {
      ...
      return qt(await c.run());
    }
    try {
      return qt(await o.run());
    } catch (c) {
      if (console.error(`"${e.name}" UI Error:`, c.stack ?? c.message), o.layer > 0) {
        ...
        if (f)
          try {
            return t.innerHTML = "", qt(await f.run());
          } catch (m) {
      ...
      if (!d)
        throw c;
      return t.innerHTML = "", qt(await d.run());
    }
  }
  /**
...
var Ee = /* @__PURE__ */ ((n) => (n.OnChange = "change", n.OnFocusOut = "focusout", n.OnSubmit = "submit", n))(Ee || {}), Aa = Object.defineProperty, Ia = (n, e, t) => e in n ? Aa(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t, O = (n, e, t) => (Ia(n, typeof e != "symbol" ? e + "" : e, t), t);
const Ft = class xe {
  constructor() {
...
const Ta = (n, e) => e.some((t) => n instanceof t);
let Es, Ss;
function Oa() {
  return Es || (Es = [
    IDBDatabase,
...
const yr = /* @__PURE__ */ new WeakMap(), zn = /* @__PURE__ */ new WeakMap(), gr = /* @__PURE__ */ new WeakMap(), Ln = /* @__PURE__ */ new WeakMap(), Zn = /* @__PURE__ */ new WeakMap();
function Ha(n) {
  ...
  return e.then((t) => {
    t instanceof IDBCursor && yr.set(t, n);
  }).catch(() => {
  }), Zn.set(e, n), e;
}
function Pa(n) {
  ...
  get(n, e, t) {
    if (n instanceof IDBTransaction) {
      ...
      if (e === "objectStoreNames")
        return n.objectStoreNames || gr.get(n);
      if (e === "store")
...
function qa(n) {
  return n === IDBDatabase.prototype.transaction && !("objectStoreNames" in IDBTransaction.prototype) ? function(e, ...t) {
    ...
    return gr.set(s, e.sort ? e.sort() : [e]), st(s);
  } : za().includes(n) ? function(...e) {
    return n.apply(Dn(this), e), st(yr.get(this));
  } : function(...e) {
    return st(n.apply(Dn(this), e));
  };
}
function Ua(n) {
  return typeof n == "function" ? qa(n) : (n instanceof IDBTransaction && Pa(n), Ta(n, Oa()) ? new Proxy(n, Hn) : n);
}
function st(n) {
...
const Dn = (n) => Zn.get(n);
function At(n, e, { blocked: t, upgrade: s, blocking: r, terminated: a } = {}) {
...
const Fa = ["get", "getKey", "getAll", "getAllKeys", "count"], Ra = ["put", "add", "delete", "clear"], An = /* @__PURE__ */ new Map();
function Ms(n, e) {
  if (!(n instanceof IDBDatabase && !(e in n) && typeof e == "string"))
    return;
  if (An.get(e))
    return An.get(e);
  const t = e.replace(/FromIndex$/, ""), s = e !== t, r = Ra.includes(t);
  if (
    // Bail if the target doesn't exist on the target. Eg, getAll isn't in Edge.
    !(t in (s ? IDBIndex : IDBObjectStore).prototype) || !(r || Fa.includes(t))
  )
    return;
...
var k = /* @__PURE__ */ ((n) => (n.Pending = "pending", n.Completed = "completed", n.Failed = "failed", n.Conflict = "conflict", n))(k || {}), De = /* @__PURE__ */ ((n) => (n.Success = "success", n.Exception = "exception", n.Failed = "failed", n.Conflict = "conflict", n))(De || {}), he = /* @__PURE__ */ ((n) => (n.Add = "add", n.Edit = "edit", n.Delete = "delete", n))(he || {}), Ke = "SharedWorker" in globalThis, Wa = class {
  constructor(n) {
...
function It(n) {
  return St().toString(36) + "-" + vr.str(JSON.stringify(n)).toString(36);
}
function Va(n) {
...
class _r {
      ...
      if (u && ((s = u.transaction.data) == null ? void 0 : s[i].new) !== void 0 && ((r = e.transaction.data) == null ? void 0 : r[i].prev) !== void 0) {
        ...
        d = await this._updateJob({
          ...
          transaction: {
            ...
            data: f,
            blitzstamp: St(),
            hash: It({ ...f, blitzID: e.transaction.blitzID, timestamp: m })
          },
  ...
  async _editAttemptHandler(e, t) {
    ...
    var f = {
      ...
      transaction: {
        ...
        data: d,
        blitzstamp: St(),
        hash: It({ ...d, blitzID: e.transaction.blitzID, timestamp: u })
      },
  ...
  async start() {
    var e, t;
    for (this._db = await At(ce.name, 1); ; ) {
      try {
...
function $s(n) {
  sn.push(n), n.onmessage = function(e) {
    e.data.type === "close" ? sn = sn.filter((t) => t !== n) : e.data.type === "headers" ? e.data.data && (wr = e.data.data) : e.data.type === "scopedHeaders" && e.data.data && (es = e.data.data);
  };
}
("SharedWorkerGlobalScope" in self || "WorkerGlobalScope" in self) && ("SharedWorkerGlobalScope" in self ? self.onconnect = (n) => $s(n.ports[0]) : $s(self), new _r().start());
class Fe {
  /**
   * Constructor.
   *
  ...
  constructor(e) {
    ...
    var t;
    this.action = e.action, this.blitzstamp = e.blitzstamp ?? St(), this.hash = e.hash ?? It(e.data === void 0 ? { blitzID: e.blitzID, milliseconds: (/* @__PURE__ */ new Date()).getTime(), rand: Math.random() } : { ...e.data, blitzID: e.blitzID, milliseconds: (/* @__PURE__ */ new Date()).getTime(), rand: Math.random() }), this.hashAlgo = e.hashAlgo ?? "b-crc32", this.blitzID = e.blitzID ?? ((t = e.data) == null ? void 0 : t._blitzID) ?? this.hash, this.model = e.model, this.data = e.data ?? {}, this.userhash = e.userhash;
  }
  /**
      ...
      if (o && ((s = o.transaction.data) == null ? void 0 : s[t].new) !== void 0 && ((r = e.transaction.data) == null ? void 0 : r[t].prev) !== void 0) {
        ...
        i = await this._updateJob({
          ...
          transaction: {
            ...
            data: l,
            blitzstamp: St(),
            hash: It({ ...l, blitzID: e.transaction.blitzID, timestamp: c })
          },
  ...
  async force(e) {
    ...
    const r = Object.keys(e.transaction.data)[0], a = await this._getFutureJobs(e, r), i = {
      ...
      transaction: {
        ...
        data: i,
        blitzstamp: St(),
        hash: It({ ...i, blitzID: e.transaction.blitzID, timestamp: o })
      },
...
class Xa {
   ...
   */
  constructor(e, t) {
    if (O(this, "root"), this.root = new Gt(), !t)
      return;
  ...
  _loadFromJson(e, t) {
    Object.keys(e).forEach((s) => {
      typeof e[s] == "string" || typeof e[s] == "boolean" || (t.children[s] || (t.children[s] = new Gt()), e[s].hasOwnProperty("isEndOfWord") && e[s].isEndOfWord && (t.children[s].isEndOfWord = !0, t.children[s].items = e[s].items), this._loadFromJson(e[s], t.children[s]));
    });
  }
  /**
   * Loads the Trie data structure from a JSON object.
   ...
   */
  loadFromJson(e) {
    return this.root = new Gt(), this._loadFromJson(e, this.root), this;
  }
  toJson() {
    const e = (t) => {
      let s = {};
  ...
  insert(e, t) {
    let s = this.root;
    for (const r of e)
      s.children[r] || (s.children[r] = new Gt()), s = s.children[r];
...
const Sr = {
  ...
  var e;
  return n === Qa ? ((e = le.getCurrentUser()) == null ? void 0 : e.id) ?? n : n;
};
function Mr(n, e, t) {
  var s;
  let r = !0;
...
class Za {
  ...
  async query(e, t) {
    ...
    for (; c; ) {
      ...
      if (Mr(c.value, e.conditions ?? [], d) && (u.push(c.value), e.limit && u.length >= e.limit))
        break;
      c = await c.continue();
    }
   ...
   */
  async search(e, t) {
    const s = await this.connect(), r = new Xa(this.model).loadFromJson(s.get("tree", this.model.getName()));
    s.close();
    const a = r.search(e);
  ...
  async connect() {
    ...
    return await At(this.model.getName(), 1, {
      upgrade: (i, o, l, c, d) => {
...
const Cr = class xr {
  ...
  async query(e = {}) {
    ...
    for (const f of a) {
      ...
      if (Mr(f, e.conditions ?? [], i) && (r.push(f), e.limit && r.length >= e.limit))
        break;
    }
...
class $e {
   ...
   */
  constructor(e, t, s) {
    O(this, "_object"), O(this, "_name"), O(this, "_type"), O(this, "_value"), O(this, "_valueSignal"), O(this, "_syncSignal"), this._name = e, this._type = t, this._value = this.unserialize(s), this._valueSignal = new jt(this._value), this._syncSignal = new jt(null);
  }
  /**
  ...
  syncStatus(e) {
    ...
    return s || pt().getJobsForObject((t = this._object) == null ? void 0 : t._blitzID.value).then((a) => {
      this._syncSignal.set(Jt(a, this._name), !1), e(this._syncSignal.get());
    }), r;
  }
  /**
...
const Lr = 6048e5, ei = 864e5, en = 43200, Ds = 1440, As = Symbol.for("constructDateFrom");
function ot(n, e) {
...
function Vt(n, e) {
  var t, s, r, a;
  const i = Kt(), o = (e == null ? void 0 : e.weekStartsOn) ?? ((s = (t = e == null ? void 0 : e.locale) == null ? void 0 : t.options) == null ? void 0 : s.weekStartsOn) ?? i.weekStartsOn ?? ((a = (r = i.locale) == null ? void 0 : r.options) == null ? void 0 : a.weekStartsOn) ?? 0, l = Te(n, e == null ? void 0 : e.in), c = l.getDay(), d = (c < o ? 7 : 0) + c - o;
  return l.setDate(l.getDate() - d), l.setHours(0, 0, 0, 0), l;
}
function fn(n, e) {
  return Vt(n, { ...e, weekStartsOn: 1 });
}
function Dr(n, e) {
...
function si(n, e) {
  const t = Dr(n, e), s = ot((e == null ? void 0 : e.in) || n, 0);
...
function ii(n) {
  return !(!ai(n) && typeof n != "number" || isNaN(+Te(n)));
}
function oi(n, e, t) {
  const [s, r] = En(
    t == null ? void 0 : t.in,
...
function hi(n, e, t) {
  ...
  let l = rn(r, a) === -i;
  fi(s) && o === 1 && rn(s, a) === 1 && (l = !1);
  const c = i * (o - +l);
  return c === 0 ? 0 : c;
}
function mi(n, e, t) {
  const s = ci(n, e) / 1e3;
  return li(t == null ? void 0 : t.roundingMethod)(s);
}
function pi(n, e) {
  const t = Te(n, e == null ? void 0 : e.in);
...
function Ne(n) {
  return (e, t = {}) => {
    ...
    if (!a)
      return null;
    const i = a[0], o = s && n.parsePatterns[s] || n.parsePatterns[n.defaultParseWidth], l = Array.isArray(o) ? ji(o, (u) => u.test(i)) : (
...
const Ti = /^(\d+)(th|st|nd|rd)?/i, Oi = /\d+/i, zi = {
  narrow: /^(b|a)/i,
...
function Ki(n, e) {
  var t, s, r, a;
  const i = Kt(), o = (e == null ? void 0 : e.firstWeekContainsDate) ?? ((s = (t = e == null ? void 0 : e.locale) == null ? void 0 : t.options) == null ? void 0 : s.firstWeekContainsDate) ?? i.firstWeekContainsDate ?? ((a = (r = i.locale) == null ? void 0 : r.options) == null ? void 0 : a.firstWeekContainsDate) ?? 1, l = Ar(n, e), c = ot((e == null ? void 0 : e.in) || n, 0);
  return c.setFullYear(l, 0, o), c.setHours(0, 0, 0, 0), Vt(c, e);
}
function Xi(n, e) {
  const t = Te(n, e == null ? void 0 : e.in), s = +Vt(t, e) - +Ki(t, e);
  return Math.round(s / Lr) + 1;
}
function ye(n, e) {
...
const zs = (n, e) => {
  ...
  return a.replace("{{date}}", zs(s, e)).replace("{{time}}", Ir(r, e));
}, Zi = {
  p: Ir,
  P: Qi
}, Gi = /^D+$/, eo = /^Y+$/, to = ["D", "DD", "YY", "YYYY"];
function no(n) {
  return Gi.test(n);
}
function so(n) {
...
function ro(n, e, t) {
  const s = ao(n, e, t);
  if (console.warn(s), to.includes(n))
...
const io = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, oo = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, lo = /^'([^]*?)'?$/, co = /''/g, uo = /[a-zA-Z]/;
function jr(n, e, t) {
  var s, r, a, i, o, l, c, d;
  const u = Kt(), f = (t == null ? void 0 : t.locale) ?? u.locale ?? Tt, m = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((r = (s = t == null ? void 0 : t.locale) == null ? void 0 : s.options) == null ? void 0 : r.firstWeekContainsDate) ?? u.firstWeekContainsDate ?? ((i = (a = u.locale) == null ? void 0 : a.options) == null ? void 0 : i.firstWeekContainsDate) ?? 1, h = (t == null ? void 0 : t.weekStartsOn) ?? ((l = (o = t == null ? void 0 : t.locale) == null ? void 0 : o.options) == null ? void 0 : l.weekStartsOn) ?? u.weekStartsOn ?? ((d = (c = u.locale) == null ? void 0 : c.options) == null ? void 0 : d.weekStartsOn) ?? 0, p = Te(n, t == null ? void 0 : t.in);
  if (!ii(p))
    throw new RangeError("Invalid time value");
  let y = e.match(oo).map((g) => {
    const w = g[0];
    if (w === "p" || w === "P") {
      const S = Zi[w];
  ...
  return y.map((g) => {
    if (!g.isToken)
      return g.value;
    const w = g.value;
    (!(t != null && t.useAdditionalWeekYearTokens) && so(w) || !(t != null && t.useAdditionalDayOfYearTokens) && no(w)) && ro(w, e, String(n));
    const S = js[w[0]];
...
function ho(n, e, t) {
  const s = Kt(), r = (t == null ? void 0 : t.locale) ?? s.locale ?? Tt, a = 2520, i = rn(n, e);
  if (isNaN(i))
    throw new RangeError("Invalid time value");
  const o = Object.assign({}, t, {
    ...
    t == null ? void 0 : t.in,
    ...i > 0 ? [e, n] : [n, e]
  ), d = mi(c, l), u = (hn(c) - hn(l)) / 1e3, f = Math.round((d - u) / 60);
  let m;
  if (f < 2)
  ...
  if (f < Ds) {
    ...
    if (f < en) {
      ...
      return m = Math.round(f / en), r.formatDistance("aboutXMonths", m, o);
  }
  if (m = hi(c, l), m < 12) {
    const h = Math.round(f / en);
...
const Hs = {
  ...
  preprocessor: (n, e) => n.getDate() === 1 || !e.some(
    (t) => t.isToken && nl.includes(t.value)
  ) ? e : e.map(
...
}, rl = /^(\d+)(ième|ère|ème|er|e)?/i, al = /\d+/i, il = {
...
class vl extends $e {
  ...
  toFormatted(e = "en", t = !1) {
    if (!this._value)
      return null;
    const s = e === "fr" ? pn : e === "de" ? mn : Tt;
    let r = e === "de" ? "dd. MMMM yyyy" : "dd MMMM yyyy";
    return t && (r = "EEEE, " + r), jr(
...
const _l = /^[0-9]{4}\-[0-9]{2}\-[0-9]{2}\s[0-9]{2}\:[0-9]{2}\:[0-9]{2}$/;
class El extends $e {
  /**
   * Returns the unserialized value of given value.
   *
...
function kl(n, e) {
  e = e || {};
  const t = e.delimiter || ".", s = e.maxDepth, r = e.transformKey || $l, a = {};
  function i(o, l, c) {
    c = c || 1, Object.keys(o).forEach(function(d) {
      const u = o[d], f = e.safe && Array.isArray(u), m = Object.prototype.toString.call(u), h = xl(u), p = m === "[object Object]" || m === "[object Array]", y = l ? l + t + r(d) : r(d);
...
class Re {
  ...
  static createType(e, t, s) {
    ...
    if (e.endsWith("_fk"))
      return new Sl(e, t, s);
    const a = (r = Sr[e]) == null ? void 0 : r.type;
    return typeof a == "string" && (t = a), t === "user" ? new Ml(e, t, s) : t === "int" ? new Un(e, "int", s) : t === "blitzstamp" ? new Un(e, t, s) : t === "tinyint" ? new Il(e, t, s) : t === "double" ? new jl(e, t, s) : t === "float" ? new ss(e, t, s) : t === "percentage" ? new Tl(e, t, s) : t === "varchar" ? new wl(e, t, s) : t === "text" ? new Ot(e, t, s) : t === "htmlText" ? new bl(e, t, s) : t === "enum" ? new Al(e, t, s) : t === "json" ? new Ll(e, t, s) : t === "boolean" ? new kr(e, t, s) : t === "datetime" ? new El(e, "datetime", s) : t === "date" ? new vl(e, t, s) : t === "code" ? new Dl(e, t, s) : t === "email" ? new Ol(e, t, s) : t === "phone" ? new zl(e, t, s) : t === "url" ? new Hl(e, t, s) : t === "image" ? new Pl(e, t, s) : t === "video" ? new Nl(e, t, s) : t === "file" ? new ql(e, t, s) : t === "pdf" ? new Ul(e, t, s) : t === "location" ? new Fl(e, t, s) : new Rt(e, t, s);
  }
  /**
  ...
  static createMany(e, t, s) {
    return e.endsWith("_mtm") ? new Cl(e, t, s) : new Or(e, t, s);
  }
  /**
...
class yt {
  ...
  static async getHistory(e, t) {
    ...
    if (!Array.isArray(r.data)) {
      ...
      throw !r.error && r.userID !== void 0 ? new zr(a) : new Error(r.error ?? a);
    }
    return r.data.map((a) => ({
      ...a,
...
class Lt {
  ...
  constructor({ model: e, attributes: t }) {
    O(this, "_model"), O(this, "_attributes"), O(this, "listeners", /* @__PURE__ */ new Map()), O(this, "_syncSignal", new jt(null)), O(this, "editQueue", Promise.resolve()), this._model = e, this._attributes = t;
  }
  /**
  ...
  syncStatus(e) {
    ...
    return t || pt().getJobsForObject(this.getAttribute("_blitzID").value).then((r) => {
      this._syncSignal.set(Jt(r), !1), e(this._syncSignal.get());
    }), s;
  }
  /**
  ...
  async history(e) {
    ...
    for (const a of s)
      try {
        ...
        if (i instanceof zr || (i == null ? void 0 : i.name) === "AbortError")
          throw i;
 ...
 */
var Bl = function(n) {
  return n != null && (qr(n) || Jl(n) || !!n._isBuffer);
};
function qr(n) {
  return !!n.constructor && typeof n.constructor.isBuffer == "function" && n.constructor.isBuffer(n);
}
function Jl(n) {
  return typeof n.readFloatLE == "function" && typeof n.slice == "function" && qr(n.slice(0, 0));
}
(function() {
  var n = Wl, e = Fs.utf8, t = Bl, s = Fs.bin, r = function(a, i) {
  ...
  r._ff = function(a, i, o, l, c, d, u) {
    ...
    var f = a + (o ^ (i | ~l)) + (c >>> 0) + u;
    return (f << d | f >>> 32 - d) + i;
  }, r._blocksize = 16, r._digestsize = 16, Pr.exports = function(a, i) {
    if (a == null)
...
var Vl = Pr.exports;
const Yl = /* @__PURE__ */ Ja(Vl), Kl = /^[v^~<>=]*?(\d+)(?:\.([x*]|\d+)(?:\.([x*]|\d+)(?:\.([x*]|\d+))?(?:-([\da-z\-]+(?:\.[\da-z\-]+)*))?(?:\+[\da-z\-]+(?:\.[\da-z\-]+)*)?)?)?$/i, Rs = (n) => {
  if (typeof n != "string")
  ...
  return isNaN(e) ? n : e;
}, Xl = (n, e) => typeof n != typeof e ? [String(n), String(e)] : [n, e], Ql = (n, e) => {
  if (Ws(n) || Ws(e))
    return 0;
  const [t, s] = Xl(Bs(n), Bs(e));
  return t > s ? 1 : t < s ? -1 : 0;
}, Js = (n, e) => {
  for (let t = 0; t < Math.max(n.length, e.length); t++) {
    const s = Ql(n[t] || "0", e[t] || "0");
    if (s !== 0)
      return s;
  }
  return 0;
...
class Fr {
  ...
  async perform() {
    ...
    if (this.options.type.includes("model")) {
      const e = await indexedDB.databases(), t = [
        ...
        "haspublishingdate",
        "modelpermission"
      ], r = e.find((a) => a.name === "_Model") ? await At("_Model", 1) : null;
      if (r) {
        for (const a of t)
          try {
  ...
  async flush() {
    ...
    for (const r of t)
      await Gn(r);
    const s = e.find((r) => r.name === ce.name) ? await At(ce.name, 1) : null;
...
class Et {
  ...
  convertObjects(e) {
    ...
    const s = [];
    for (const r of e)
      s.push(Hr.create(((t = this._query) == null ? void 0 : t.returnType) ?? Lt, this._model, r));
    return s;
  }
  /**
    ...
    for (let a = 0; a < e.options.readURL.length; a++) {
      ...
      try {
        ...
        if (this._get)
          ...
          o = l.items || [], Fr.modelCacheUpdate(this._model, l.model);
        }
        for (const l of o) {
...
O(Wr, "SNAPSHOT_PAGE_SIZE", 1e3);
let Bn = Wr;
const Br = class Jr extends Rr {
  /**
   * Constructor.
   *
   ...
   */
  constructor({ model: e, attributes: t }) {
    super({ model: e, attributes: t }), O(this, "clusterManager"), O(this, "lastTransactionHash", null), O(this, "returnType", Lt), this.clusterManager = Z.clusterManager;
  }
  /**
  ...
  async add(e, t = []) {
    ...
    return this.memoryClient().emit(a), this.setLastTransactionHash(a.hash), Hr.create(this.returnType, this, o.data);
  }
  /**
   * Finds an object by given blitz ID.
   *
  ...
  async list(e = {}) {
    return await Et.create().model(this).clusters(this.resolveClusters(e.clusters ?? [])).raw(e.raw ?? !1).query({
      ...
      limit: e.limit,
      returnType: e.returnType ?? this.returnType ?? Lt,
...
class nc {
  constructor() {
    O(this, "_db", null), O(this, "conflictHandler", null), O(this, "failedHandler", null), O(this, "notifier", new tc({
  ...
  async updateSyncStatus(e, t) {
    ...
    if (t)
      ...
      (a = d == null ? void 0 : d._syncSignal) == null || a.set(Jt(u, c)), (i = l._syncSignal) == null || i.set(Jt(u));
    }
  }
  /**
   ...
   */
  async init() {
    if (this._db = await At(ce.name, 1, {
      upgrade: (s) => {
    ...
    this.conflictHandler = new Ka(this._db), this.failedHandler = new ec(this._db);
    const e = new Ba(
      Z.options.queue.workerPath,
      { name: "bd-queue-worker" }
    );
    e.onerror = () => {
      console.warn("⚠️ Failed to run the queue's shared worker, please check that the worker path is correct, falling back to running on the same thread!"), new _r(
...
const mt = class Ie {
  ...
  */
  ...
  static async initialize(e) {
    ...
    this.options = t, t.clusters && Ie.setClusters(t.clusters), await new Fr(this.options.flush).perform(), await new rt().ping(), this.queue = await new nc().init(), Ie._Model = new gt({
      model: void 0,
      attributes: {
        _blitzID: new Rt("_blitzID", "string", "_Model"),
        searchable: new Rt("searchable", "json", void 0),
        attributes: new Rt("attributes", "json", {
          name: {
            label: "Name",
            type: "varchar"
          },
        ...
        _editURLs: new Rt("_editURLs", "json", []),
        haspublishingdate: new kr("haspublishingdate", "boolean", !1)
      }
...
const Mn = (n, e) => {
  ...
  return Mn(a, s), a;
}, et = (n) => (Array.isArray(n) ? n.length > 0 : n !== "" && n != null) ? n : null, sc = `<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`, rc = `<svg width="18px" height="18px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  type: "email",
  empty: (n) => !n,
  defaultConfig: { type: "email", iconSvg: sc },
  control: ze(We, ({ onChange: n }) => ({
    onChange: (e) => n(et(e))
  }))
}, dc = {
  type: ["url", "youtube"],
  empty: (n) => !n,
  defaultConfig: { type: "url", iconSvg: rc },
  control: ze(We, ({ onChange: n }) => ({
    onChange: (e) => n(et(e))
  }))
};
...
function pe(n) {
  return String(n ?? "").replace(/[&<>"']/g, (e) => Cc[e]);
}
class Vr {
  constructor(e) {
    this.html = e;
...
const xc = /^\s*(javascript|data|vbscript):/i;
function Je(n) {
  const e = String(n ?? "");
  return xc.test(e) ? "#" : pe(e);
}
function ee(n, ...e) {
  return n.reduce((t, s, r) => t + s + (r < e.length ? e[r] instanceof Vr ? e[r].html : pe(e[r]) : ""), "");
}
function Yr(n, e) {
...
const $c = (n) => {
  ...
  view: ({ value: n }) => ({
    html: ee`<a class="bd-pdf-doc" href="${se(Je(n))}" target="_blank" rel="noopener noreferrer">
            <img class="bd-pdf" alt="" loading="lazy" src="${se(Je($c(n)))}" />
            <span class="bd-pdf-fallback" hidden>${kc(n)}</span>
        </a>`,
    hydrate: (e) => {
...
function us(n, e) {
  ...
  const _ = (C, z) => {
    ...
    try {
      await fr(o), r != null && r.lat && ($.value = r.lat), r != null && r.lng && (P.value = r.lng), r != null && r.address && (v.value = r.address), r != null && r.street && (M.value = r.street), r != null && r.street_number && (b.value = r.street_number), r != null && r.postal_code && (j.value = r.postal_code), r != null && r.city && (E.value = r.city), r != null && r.country && (L.value = r.country);
...
const Dc = ln(() => import("./index-c429c8db.js")), Ac = ln(() => import("./index-efcddc26.js")), Ic = {
  type: "phone",
  empty: (n) => !n,
  control: ze(Dc, ({ onChange: n }) => ({
    onChange: (e) => n(et(e))
  }))
}, jc = /^<p id="[A-Za-z0-9_-]+"><br><\/p>$/, Tc = {
  type: "htmlText",
  empty: (n) => !n,
  defaultConfig: { presentation: { grid: "modal", form: "expandable" } },
  control: ze(Ac, ({ onChange: n }) => ({
    onChange: (e) => n(et(jc.test(e) ? "" : e))
  }))
}, Oc = {
  type: "location",
  empty: (n) => !n,
...
async function $n(n, e) {
  ...
  const L = S.querySelector(".dropdown"), _ = S.querySelector(".sync-status"), A = S.querySelector(".picker-spinner"), H = S.querySelector(".picker-value"), x = S.querySelector(".empty"), C = S.querySelector(".search-input"), z = S.querySelector(".menu"), J = S.querySelector(".container"), U = S.querySelector(".list"), oe = S.querySelector(".refresh-btn"), R = S.querySelectorAll(".doc-btn"), K = S.querySelector(".clear-btn"), X = S.querySelector(".next-btn"), be = S.querySelector(".expand-btn"), me = () => {
    ...
    if (!z)
      return;
    z.style.display = "";
    const B = z.offsetHeight + zc, re = window.innerHeight - L.getBoundingClientRect().bottom, de = J.getBoundingClientRect().top;
    ...
    if (H)
      if (M.length > 0 && $.length > 0) {
        ...
        for (const de of M) {
          const fe = Hc(de.value), we = U.querySelector(`.list-item button[value=${fe}]`);
    ...
    if (A.style.display = "none", x && (x.style.display = $.length === 0 ? "" : "none"), C && (C.style.display = P > 7 ? "" : "none"), U) {
      ...
      let re = [];
      if (f && $.some((fe) => !!fe.obj)) {
        re = Pc($), U.innerHTML = re.map(({ expanded: fe, parent: we, children: Se }) => {
          let _e = !1;
          const Oe = Se.map((Ue) => {
            const Ct = M.find((Zt) => Zt.value === Ue.value);
...
`);
  ...
  a.addEventListener("click", f), o.addEventListener("click", f), i.addEventListener("click", (m) => m.stopPropagation()), l && l.addEventListener("input", (m) => {
    ...
    h ? (r = e.filter((p) => p.label.match(new RegExp(Ht(h), "gi"))), r.sort((p, y) => p.label.length - y.label.length)) : r = e, u();
...
async function Yt(n, e) {
  ...
  const { handleSyncStatus: l, destroy: c } = await $n(
    n,
    {
      ...
      onSearch: async (u) => {
        if (u) {
          const f = o.filter((m) => m.label.match(new RegExp(Ht(u), "gi")));
...
const Ks = (n) => ({ getAttributeDetails: () => n.attributeDetails }), qc = {
  type: ["enum", "enum[]"],
  control: async (n) => {
    const { host: e, value: t, onChange: s, config: r, status: a } = n, { handleSyncStatus: i, destroy: o } = await Yt(e, {
      ...r,
      model: Ks(n),
  ...
  filter: async (n) => {
    const { host: e, value: t, onChange: s, config: r } = n, { destroy: a } = await Yt(e, {
      ...r,
      model: Ks(n),
      attribute: r.className ?? "value",
  ...
  return Qt(n.host, { ...n.config, model: t, groupByParent: !0, ...e });
}, Kr = async (n) => {
  var t;
  ...
  filter: async (n) => {
    var s;
    const e = await n.resolveModel(n.config.usersModel), { destroy: t } = await Qt(n.host, {
      ...n.config,
      model: e,
      multiple: !0,
      limit: 100,
...
const Xc = /(?:youtube\.com\/(?:watch\?(?:.*&)?v=|shorts\/|embed\/|live\/)|youtu\.be\/)([A-Za-z0-9_-]{11})/;
function Qc(n) {
  const e = n.match(Xc);
  return e ? e[1] : null;
}
...
function Zr(n) {
  const e = Qr(n, "unit"), t = Array.isArray(e) ? e[0] : e;
  return typeof t == "string" && t !== "" ? t : void 0;
}
const Gc = (n, e) => {
  const t = parseFloat(n.value);
  return ut(n.value) || isNaN(t) ? "" : `<p class="${n._name} bd-currency">${(e == null ? void 0 : e.labelHtml) ?? ""}${Xr(t, Zr(n))}</p>`;
}, eu = (n, e) => ut(n.value) ? "" : `<p class="${n._name} bd-percentage">${(e == null ? void 0 : e.labelHtml) ?? ""}${pe(Bc(n.value))} <span class="bd-percentage-sign">%</span></p>`, tu = (n, e) => {
  const t = Vc(n.value);
  if (t === null)
    return "";
  const s = Jc(t), r = ["d", "h", "m", "s"].filter((i) => s[i] > 0), a = (r.length > 0 ? r : ["s"]).map(
...
}, ru = (n, e) => ut(n.value) ? "" : `<div class="${n._name} bd-url">
  ...
  if (ut(t))
    return "";
  const s = typeof t == "object" ? Kc(t, ie == null ? void 0 : ie.defaultLanguage) : String(t);
...
function ou(n) {
  ...
  if (Array.isArray(n))
    ...
    e = [n];
  return e.map((t) => Bt(t)).filter((t) => t != null && t !== "").map((t) => String(t).split("|")[0]);
}
const lu = (n, e) => {
  if (ut(n.value))
    return "";
  ...
  if (!(t != null && t.url))
    return "";
  const s = Zc(t), r = s ? `<span class="bd-youtube-poster"><span class="bd-youtube-play"></span><img alt="" src="${Je(s)}" /></span>` : '<span class="bd-youtube-label">&#9654; YOUTUBE</span>';
  ...
  var d, u;
  const t = Qr(n, "formula"), s = typeof t == "string" && t !== "" ? t : n.value;
  ...
  const l = Zr(n), c = l ? Xr(o, l) : String(o);
  return `<p class="${n._name} bd-formula" title="${pe(r)}">${(e == null ? void 0 : e.labelHtml) ?? ""}${c}</p>`;
}, du = (n, e) => ut(n.value) ? "" : `<p class="${n._name} bd-hex">${(e == null ? void 0 : e.labelHtml) ?? ""}${pe(n.value)}</p>`, fu = (n, e) => {
  const t = n.value;
...
function Gr(n) {
  for (const [e, t] of Object.entries(hu))
    n.registry.mergeBuiltin(e, {
      view: Wt(t, e === "location" ? mu : void 0)
    });
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-f1198b45.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-c0be4c13.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-ad4b6a7d.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-a0c0f571.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-0907e6f4.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-22215f70.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-b5cb772c.js"))) });
}
async function pu(n, e) {
  ...
  const { handleSyncStatus: c, destroy: d } = await $n(
    n,
    {
      ...
      onSearch: async (u) => {
        if (u) {
          const f = l.filter((m) => m.label.match(new RegExp(Ht(u), "gi")));
          return f.sort((m, h) => m.label.length - h.label.length), f;
        } else
          return l;
      },
...
async function yu(n, e) {
  ...
  const a = t.map((l) => typeof l == "string" ? { value: l, label: l } : l), { handleSyncStatus: i, destroy: o } = await $n(
    n,
    {
      ...
      onSearch: async (l) => {
        if (l) {
          const c = a.filter((d) => d.label.match(new RegExp(Ht(l), "gi")));
...
async function gu(n, e, t) {
  ...
  const r = await Ae._Model.get(s), { handleSyncStatus: a, destroy: i } = await Qt(e, {
    ...t,
    model: r,
    initialValue: n.value,
    initialLabel: void 0,
...
async function vu(n, e, t) {
  ...
  const { handleSyncStatus: s, destroy: r } = await Yt(e, {
    ...t,
...
async function Cu(n, e, t) {
  ...
  const { handleSyncStatus: s, destroy: r } = Xt(e, {
    ...t,
    time: !1,
    initialValue: n.value,
    onChange: async (i) => {
...
const Fu = /^\s*(javascript|data|vbscript):/i, Ru = /^\|?\s*:?-+:?\s*(\|\s*:?-+:?\s*)*\|?$/, er = (n) => {
  let e = n.trim();
  return e.startsWith("|") && (e = e.slice(1)), e.endsWith("|") && (e = e.slice(0, -1)), e.split("|").map((t) => t.trim());
}, tr = (n) => Fu.test(n) ? "#" : n;
function $t(n) {
  return n.replace(/`([^`]+)`/g, "<code>$1</code>").replace(/!\[([^\]]*)\]\(([^)\s]+)\)/g, (e, t, s) => `<img alt="${t}" src="${tr(s)}" />`).replace(/\[([^\]]+)\]\(([^)\s]+)\)/g, (e, t, s) => `<a href="${tr(s)}">${t}</a>`).replace(/\*\*([^*]+)\*\*/g, "<strong>$1</strong>").replace(/\*([^*]+)\*/g, "<em>$1</em>");
}
function ea(n) {
  const e = pe(n.replace(/\r\n?/g, `
`)).split(`
`), t = [];
  let s = [], r = null, a = [], i = null, o = null;
  const l = () => {
    s.length && t.push(`<p>${s.map($t).join("<br />")}</p>`), s = [];
  }, c = () => {
    r && t.push(`<${r.tag}>${r.items.map((m) => `<li>${$t(m)}</li>`).join("")}</${r.tag}>`), r = null;
  }, d = () => {
    a.length && t.push(`<blockquote>${a.map($t).join("<br />")}</blockquote>`), a = [];
  }, u = () => {
    if (o) {
      const m = `<tr>${o.header.map((p) => `<th>${$t(p)}</th>`).join("")}</tr>`, h = o.rows.map((p) => `<tr>${p.map((y) => `<td>${$t(y)}</td>`).join("")}</tr>`).join("");
      t.push(`<table><thead>${m}</thead><tbody>${h}</tbody></table>`);
    }
    o = null;
  }, f = () => {
    l(), c(), d(), u();
  ...
  for (let m = 0; m < e.length; m++) {
    const h = e[m];
    if (i) {
      /^```/.test(h) ? (t.push(`<pre><code>${i.join(`
`)}</code></pre>`), i = null) : i.push(h);
      continue;
    }
    if (/^```/.test(h)) {
      f(), i = [];
    ...
    if (o) {
      if (h.trim() !== "" && h.includes("|")) {
        o.rows.push(er(h));
        continue;
      }
      u();
    }
    const p = h.match(/^(#{1,6})\s+(.*)$/);
    if (p) {
      f(), t.push(`<h${p[1].length}>${$t(p[2])}</h${p[1].length}>`);
      continue;
    }
    if (/^\s*(-{3,}|\*{3,})\s*$/.test(h)) {
      f(), t.push("<hr />");
    ...
    const v = h.match(/^\s*[-*]\s+(.*)$/), g = h.match(/^\s*\d+\.\s+(.*)$/);
    if (v || g) {
      l(), d();
      const w = v ? "ul" : "ol";
      (!r || r.tag !== w) && (c(), r = { tag: w, items: [] }), r.items.push((v ?? g)[1]);
      continue;
    }
    if (h.includes("|") && m + 1 < e.length && Ru.test(e[m + 1])) {
      f(), o = { header: er(h), rows: [] }, m++;
      continue;
    }
    if (h.trim() === "") {
      f();
...
const tn = (n, e) => `<p class="${`${n._name} bd-number`}">${(e == null ? void 0 : e.labelHtml) ?? ""}${n.value.toString()}</p>`, Jn = (n, e) => {
  const t = (n.value instanceof Array ? n.value : [n.value]).map(Bt);
  ...
  image: (n, e) => {
    const t = (n.value instanceof Array ? n.value : [n.value]).map((s) => Bt(s)).filter((s) => s && s.base && s.sd);
...
}, Ju = Bu, Vn = /* @__PURE__ */ new WeakMap(), gn = /* @__PURE__ */ new Set();
let Dt = null;
function Vu() {
  Dt || typeof MutationObserver > "u" || (Dt = new MutationObserver((n) => {
    for (const e of n)
      for (const t of Array.from(e.removedNodes))
        if (t instanceof Element)
          for (const s of Array.from(gn))
            (t === s || t.contains(s)) && (s.isConnected || Yu(s));
  }), Dt.observe(document.documentElement, { childList: !0, subtree: !0 }));
}
function Yu(n) {
  const e = Vn.get(n);
  Vn.delete(n), gn.delete(n), e && e(), gn.size === 0 && Dt && (Dt.disconnect(), Dt = null);
}
function ta(n, e, t) {
  const s = e(n, t);
  typeof s == "function" && (Vn.set(n, s), gn.add(n), Vu());
}
function Ku(n, e) {
  var r, a, i, o, l;
...
function sa(n, e, t, s) {
  var i, o;
  return typeof t == "boolean" && t === !0 || Array.isArray(t) && t.includes(e) ? e.startsWith("since:") ? `<b class="bd-label">${e.split("since:")[1]}: </b>` : `<b class="bd-label">${zt((i = n[e]) == null ? void 0 : i["label-int"], (o = n[e]) == null ? void 0 : o.label, s, e)}: </b>` : "";
}
async function ra(n, e) {
  var l, c, d;
  if (!n)
    throw new Error("Missing attribute(s)!");
  const { labelLanguage: t, enableLabels: s } = e ?? {}, r = t ?? (ie == null ? void 0 : ie.defaultLanguage) ?? "en", a = na(n), i = a.length > 0 ? ((c = (l = a[0]._object) == null ? void 0 : l.model) == null ? void 0 : c.getAttributesDetails()) ?? {} : {}, o = [];
  for (const u of a) {
    ...
    if (!f && !i[u._name])
      continue;
    const m = u._name.endsWith("_fk"), h = u._name.endsWith("_mtm"), p = sa(i, u._name, s, r);
    if (m || h) {
...
async function fs(n, e) {
  ...
  }, d = na(n), u = d.length > 0 ? ((v = (y = d[0]._object) == null ? void 0 : y.model) == null ? void 0 : v.getAttributesDetails()) ?? {} : {}, f = t ?? (ie == null ? void 0 : ie.defaultLanguage) ?? "en", m = r ?? (ie == null ? void 0 : ie.googleMapsApiKey) ?? null, h = (g) => sa(u, g, s, f), p = [];
  for (const g of d) {
...
`), Yn(g._type).then(async (E) => {
    ...
    if (b && g._type === "location") {
      ...
      E === 0 && typeof j(g, { labelHtml: P, isSince: w }) == "string" && (await Qu.location(b, g, { googleMapsApiKey: m }) || (b = null));
    }
...
const Gu = ["boolean", "datetime", "date", "image", "video", "file"];
function aa(n, e, t) {
  var oe;
  if (!n)
  ...
  const w = s.querySelector(".bd-addform"), S = m ?? (ie == null ? void 0 : ie.defaultLanguage) ?? "en", $ = n.getAttributesDetails() ?? {}, P = Array.isArray(r) ? r : Object.keys($), M = (R) => zt($[R]["label-int"], $[R].label, S, R), b = (lt ?? Ae.ui).kernel, j = (lt ?? Ae.ui).services, E = { image: 0, video: 0, file: 0 }, L = (R, K) => async (X) => {
    E[R]++;
    try {
      return await K(X);
    } finally {
  ...
  for (const R of P) {
    if (!$[R])
      continue;
    const K = $[R], X = Array.isArray(K.type) ? K.type[0] : K.type, be = Array.isArray(K.type), me = o || i.includes(R), ke = l || Gu.includes(X) ? M(R) + (me ? " *" : "") : void 0, N = Sa(C, R, K, n, {
      className: R,
      label: ke,
      placeholder: `${M(R)}...`,
      ...h ? { defaultDialCode: h } : {},
...
function Pt(n, e) {
  ...
  n.setAttribute("role", "dialog"), n.setAttribute("aria-modal", "true"), t && (t.id || (t.id = `bd-dialog-title-${++ed}`), n.setAttribute("aria-labelledby", t.id)), s && (s.setAttribute("role", "button"), s.setAttribute("aria-label", "Close"), s.tabIndex = 0, s.addEventListener("keydown", (d) => {
  ...
  n.tabIndex = -1, (n.querySelector(jn) ?? n).focus(), ++nr === 1 && (document.body.style.overflowY = "hidden");
  const i = () => {
  ...
  return document.addEventListener("keydown", l), document.addEventListener("focusin", c), () => {
    document.removeEventListener("keydown", l), document.removeEventListener("focusin", c), --nr === 0 && (document.body.style.overflowY = ""), a != null && a.isConnected && a.focus();
  };
}
function td(n, e) {
  if (!n)
  ...
  }, l.append(c), document.body.append(l), y = Pt(l, {
...
async function ia(n, e, t, s) {
  const r = s ?? lt, a = (u) => r ? r.getHTML(u) : ra(u);
  let i = e;
  const o = [
    // Find UI variables
    ...
    try {
      ...
      if (y === "since") {
        if (n._publishingdate && typeof n._publishingdate.toRelative == "function") {
          ...
          if (g) {
            const w = new Ot("since", "varchar", g);
            w.withObject(p);
            const S = await a(w);
            i = i.replaceAll(h, () => S ?? "");
            continue;
      ...
      if (v.length === 2) {
        if (n[v[0]] && typeof n[v[0]].value == "object" && n[v[0]].value !== null && Object.hasOwn(n[v[0]].value, v[1])) {
          if (f === "ui") {
            const w = new Ot(v[0], "varchar", n[v[0]].value[v[1]]);
            w.withObject(p);
            const S = await a(w);
            i = i.replaceAll(h, () => S ?? "");
          } else
    ...
    try {
      ...
      if (u.length === 2) {
        if (n[u[0]] && typeof n[u[0]].value == "object" && n[u[0]].value !== null && Object.hasOwn(n[u[0]].value, u[1])) {
          const h = new Ot(u[0], "varchar", n[u[0]].value[u[1]]);
          h.withObject(c);
          const p = await a(h, t);
  ...
  if (t != null && t.sinceLabel)
    try {
      if (n._publishingdate && typeof n._publishingdate.toRelative == "function") {
        ...
        if (l) {
          const c = new Ot("since:" + t.sinceLabel, "varchar", l);
          c.withObject(n);
          const d = await a(c, t);
          d && i.push(d);
        }
...
function nd(n, e) {
  const t = sr(n), s = sr(e), r = { before: [], after: [], replaced: !0 };
  kt(r.before, t.lead, !1), kt(r.after, s.lead, !1);
  const a = /* @__PURE__ */ new Map(), i = (l, c, d, u, f) => {
    if (d >= u)
      return;
    kt(l, a.get(l) ?? "", !1), a.set(l, "");
    let m = "";
    for (let h = d; h < u; h++)
  ...
  return o(0, t.tokens.length, 0, s.tokens.length), kt(r.before, a.get(r.before) ?? "", !1), kt(r.after, a.get(r.after) ?? "", !1), r;
}
const sd = "@NULL", Tn = { known: !1, value: null };
function On(n) {
  if (n == null || n === sd)
    return null;
  if (typeof n == "string")
...
function Kn(n) {
  return n != null && n.attribute ? n.attribute : rd(vn(n));
}
function la(n) {
  var s;
  const e = Kn(n);
...
function kn(n, e, t = {}) {
  ...
  function $(_, A) {
    if (_.action === "add")
      return P(_);
    const H = g(_.newValue), x = ca(l, A), C = x.known ? x.value ?? "" : null;
    if (H == null && !x.known)
      return "";
    if (C == null)
    ...
    const J = Math.max(C.length, (H ?? "").length) >= v ? nd(C, H ?? "") : null, U = J && !J.replaced ? J : null;
    return ee`<div class="bd-oh-change">
  ...
  function M(_, A) {
    const H = la(_), x = H ? `.${H}` : "", C = _.attribute ? ee`<span class="bd-oh-attribute" title="${_.attribute}${x}">${i(_.attribute)}${x}</span>` : "", z = _._userID ? `user ${_._userID}` : null;
...
async function ua(n, e, t) {
  ...
  if (c) {
    ...
    u = await ia(n, h, { labelLanguage: r, googleMapsApiKey: o });
  } else {
    const h = typeof l == "function" ? l(n) : l;
    u = await oa(n, h, { labelLanguage: r, enableLabels: a, sinceLabel: i, googleMapsApiKey: o });
  }
...
function da(n, e) {
  ...
  let m = null;
  ua(n, f, o).then(({ destroy: y }) => m = y).catch((y) => console.error("mountObjectViewModal: view failed to render:", y));
  let h = null;
  const p = () => {
    h == null || h(), typeof m == "function" && m(), c.remove(), i && i(n);
  };
  return c.onclick = () => p(), u.onclick = () => p(), c.append(d), document.body.append(c), h = Pt(c, {
...
function ad(n, e, t, s) {
  ...
  const j = r.querySelector(".bd-list"), E = fa(n, t, (x, C) => {
    w = x, b = C, H();
  }), L = () => {
    E(), r.innerHTML = "";
  }, _ = (x) => {
      ...
      for (const U of z) {
        ...
        try {
          if (i) {
            ...
            R = await ia(U, K, { labelLanguage: o, googleMapsApiKey: d }, this);
          } else {
            const K = typeof a == "function" ? a(U) : a;
            R = await oa(U, K, { labelLanguage: o, enableLabels: l, sinceLabel: c, googleMapsApiKey: d }, this);
          }
        } catch (K) {
        ...
        if (R) {
          if (R.className = "attributes", oe.append(R), (typeof v == "function" || f) && (R.onclick = () => {
            v && v(U), f && da(U, { labelLanguage: o, enableLabels: l, googleMapsApiKey: d, ...m });
          }), u) {
...
function hs(n, e) {
  ...
  return i.onclick = () => f(), l.onclick = () => f(), i.append(o), document.body.append(i), u = Pt(i, {
...
function id(n, e, t, s) {
  ...
  const { headerLabel: a, labelLanguage: i, searchRow: o, actions: l, allowDelete: c, readonly: d, noResultsMessage: u, onRowClick: f, reorder: m, tree: h, status: p } = s ?? {}, y = n.getAttributesDetails() ?? {}, v = Object.keys(y).filter((D) => !D.startsWith("_")), g = i ?? ((Ct = this.settings) == null ? void 0 : Ct.language) ?? "en", w = (D) => {
    var q, V;
    return a ? a(D, y[D]) : zt((q = y[D]) == null ? void 0 : q["label-int"], (V = y[D]) == null ? void 0 : V.label, g, D);
  };
  let S = [], $ = !1, P = null, M = null, b = null, j = !0, E = !1, L = null;
  const _ = {}, A = (D) => {
    var q, V;
    return ["1", !0].includes((V = (q = n._attributes) == null ? void 0 : q[D]) == null ? void 0 : V.value);
  }, x = A("hasprojects") && !!((Zt = t == null ? void 0 : t.conditions) != null && Zt.some((D) => (D == null ? void 0 : D[0]) === "project_fk" && (D == null ? void 0 : D[1]) === "=")) ? "_projectsort" : "_sort", C = m !== !1 && !d && A("hassort") && (!(t != null && t.customSort) || t.customSort === x) && (t == null ? void 0 : t.customSortDirection) !== "ASC", z = (D) => {
    var q;
  ...
  const B = (D, q) => {
    ...
    const tt = (Ye, dt, Ze, ft) => {
      ...
      return wt.textContent = Ye, wt.title = dt, wt.disabled = Ze, wt.onclick = () => U(D, Ce.filter((ga) => ga !== D), ft), wt;
    };
    return ge.append(
...
function ms(n, e, t, s) {
  ...
  const h = r.querySelector(".bd-filtersform"), p = n.getAttributesDetails() ?? {}, y = ((H = n.getSystemAttributesDetails) == null ? void 0 : H.call(n)) ?? {}, v = (x) => p[x] ?? (i != null && i.includes(x) ? x === "project_fk" ? { type: "_Project", label: "Project" } : y[x] : void 0), g = c ?? (ie == null ? void 0 : ie.defaultLanguage) ?? "en", w = (x) => {
    if (o != null && o[x])
      return o[x];
    const C = v(x);
    return zt(C == null ? void 0 : C["label-int"], C == null ? void 0 : C.label, g, x);
  ...
  for (const x of L) {
    const C = u ? w(x) : void 0, z = dr(M, x, v(x), n, d ? () => _() : void 0, {
      className: x,
      label: C,
      placeholder: C ? `${C}...` : w(x),
      ...l ? { sortDirection: l } : {}
  ...
  const _ = () => {
    const x = $ != null && $.value ? (z) => S.some(
      (J) => typeof z[J].value == "string" && z[J].value.match(new RegExp(Ht($.value), "gi"))
    ) : null, C = hr(M);
    t(
...
function ha(n, e, t) {
  ...
  }, a.append(i), document.body.append(a), d = Pt(a, {
    titleElm: i.querySelector(".title"),
    closeElm: o,
    onEscape: () => u()
  }), { destroy: u };
}
function od(n, e, t, s, r) {
  if (!n)
    throw new Error("Missing model!");
  if (!t)
    throw new Error("Missing change callback!");
...
async function ld(n, e) {
  ...
  l.querySelector(".title").textContent = t ?? zt(c["label-int"], c.label, (($ = this.settings) == null ? void 0 : $.language) ?? "en", n._name);
  ...
  return o.onclick = () => y(), l.querySelector(".close-btn").onclick = () => y(), o.append(l), document.body.append(o), f = Pt(o, {
...
const cd = `<svg width="14px" height="14px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path stroke="#6b7280" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M14 4h6v6M10 20H4v-6M20 4l-7 7M4 20l7-7" />
</svg>`;
async function ar(n, e, t, s) {
...
const ud = ["htmlText", "image", "video", "file", "location", "youtube", "tag", "code"], dd = ["image", "tag"];
var Ae, ie, lt;
class ps {
  /**
   * Constructor
  ...
  constructor(e, t) {
     ...
     */
    ne(this, "registry", new _a((e) => this.warn(e)));
    ne(this, "uiConfig", new Ea());
    ne(this, "kernel", new Da({
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-c429c8db.js")),
      boolean: as,
      date: Xt,
      html: ln(() => import("./index-efcddc26.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Yr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-181205c6.js")),
      varchar: bu,
      text: Qs,
      markdown: Qs,
      tag: Au,
      texti18n: Iu,
      email: wu,
      phone: nt(() => import("./index-27fe58af.js")),
      url: _u,
      youtube: zu,
      int: Zs,
      tinyint: Zs,
    ...
    ne(this, "mountHtmlElement", Zu);
    ne(this, "mountAddForm", aa);
    ne(this, "mountAddFormModal", td);
    ne(this, "mountList", ad);
    ne(this, "mountGrid", id);
    ne(this, "mountFiltersForm", ms);
    ne(this, "mountFiltersModal", ha);
    ne(this, "mountSearchBox", od);
    ne(this, "mountObjectView", ua);
    ne(this, "mountObjectViewModal", da);
    ne(this, "mountObjectHistory", kn);
    ne(this, "mountObjectHistoryModal", hs);
    ne(this, "mountEditorInModal", ld);
    var o;
    Ae = e;
    ...
    for (const l of Wc)
      this.registry.register(this.withCanonicalView(ur(l.type), l));
    ...
    for (const [l, c] of Object.entries(Wu))
      this.registry.mergeBuiltin(l, { view: Wt(c) });
    r === "extended" && Gr(this), this.settings = {
  ...
  setRemoteUI(e, t) {
    const { shell: s, preload: r } = this.buildRemote(e, t, (a, i, o) => {
      o ? (typeof i.view == "function" && (a.view = Wt(i.view, i.hydrator)), this.registry.definePreset(e, a), this.registry.defineUI(e, a)) : (this.definePreset(e, a), a.control && this.registry.defineUI(e, { control: a.control }));
    });
  ...
  setRemoteUIFor(e, t, s) {
    const r = `${e}.${t}`, { shell: a, preload: i } = this.buildRemote(r, s, (o, l, c) => {
      c ? (typeof l.view == "function" && (o.view = Wt(l.view, l.hydrator)), this.registry.defineUIFor(e, t, o)) : this.defineUIFor(e, t, o);
    });
  ...
  syncTransactionInspector() {
    typeof document > "u" || (this.txiWanted && !this.txiHandle && !this.txiLoading ? (this.txiLoading = !0, Promise.resolve().then(() => yd).then(({ default: e }) => {
  ...
  canonicalView(e, t, s) {
    return (r, a) => {
      ...
      if (!d)
        return "";
      const u = (w) => fd(w, `${r._name} bd-${e}`, a == null ? void 0 : a.labelHtml);
   ...
   */
  resolveView(e) {
    const t = this.kernel.resolveForPort(Nt(e));
    return t.view ? { render: t.view, layer: t.sources.view.layer } : { render: Wt(Ju), layer: 0 };
  }
  /**
  ...
  hydrate(e) {
    return Xu(e, (t) => this.resolveHydrator(t), (t) => this.warn(t));
  }
  wrapMarkup(e) {
  ...
  resolveReadonlyString(e, t) {
    ...
    return Ku(r, e) || this.warn(`${e._name}: view hydrates but attribute has no resolvable object — shell stays static`), r.outerHTML;
  }
  /**
  ...
  resolveReadonlyElement(e, t) {
    ...
    return typeof s == "object" && s.hydrate && ta(r, (a) => s.hydrate(a) ?? void 0, e), r;
  }
  /**
  ...
  async mountEditor(e, t, s) {
    ...
    if (a.length === 1) {
      const d = a[0], u = this.kernel.resolveConfig(Nt(d, { ...s, ...s == null ? void 0 : s.config }), s == null ? void 0 : s.use), f = rr(u, (s == null ? void 0 : s.context) ?? "form", d.value);
      if (f === "modal")
      ...
      return f === "expandable" ? ar.call(this, d, r, h, {
        use: s == null ? void 0 : s.use,
        config: s == null ? void 0 : s.config,
      ...
      const u = (s == null ? void 0 : s.labelLanguage) ?? this.settings.language ?? "en", f = (h) => {
        var p, y;
        return zt((p = o[h]) == null ? void 0 : p["label-int"], (y = o[h]) == null ? void 0 : y.label, u, h);
      };
      let m = [];
      for (const h of a) {
        if (!o[h._name])
        ...
        const y = s != null && s.withLabels || ["boolean", "datetime", "date", "image", "video", "file"].includes(h._type) ? f(h._name) : void 0, v = y ? `${y}...` : f(h._name), g = {
          ...
          const b = await this.kernel.mount(Nt(h, g), p, "write"), { getDraft: j, isPending: E, cancelPending: L } = b;
          return { destroy: b, ...j && { getDraft: j }, ...E && { isPending: E }, ...L && { cancelPending: L } };
        }, S = async () => {
          let b = await w();
          return s != null && s.live && (b = this.withLiveRemount(h, p, w, b)), b;
        }, $ = this.kernel.resolveConfig(Nt(h, g)), P = rr($, "form", h.value);
        let M;
        try {
          M = P === "inline" ? await S() : await ar.call(this, h, p, S, {
            config: s == null ? void 0 : s.config,
...
function ma(n = document, e = "[data-lightbox]", t = {}) {
...
const pd = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="17 1 21 5 17 9"></polyline><path d="M3 11V9a4 4 0 0 1 4-4h14"></path><polyline points="7 23 3 19 7 15"></polyline><path d="M21 13v2a4 4 0 0 1-4 4H3"></path></svg>';
function ya(n = {}) {
  const { label: e, right: t, ...s } = n, r = document.createElement("div");
  r.className = "bd-txi-tab", t !== void 0 && (r.style.right = `${t}px`), r.innerHTML = pd, r.append(e ?? "Transactions");
  const a = document.createElement("span");
  ...
  function m() {
    ...
    v.className = "bd-txi-panel-body", p.append(y, v), d.append(p), document.body.append(d), u = pa(v, s), d.onclick = () => h(), y.onclick = () => h(), f = Pt(d, {
...
const yd = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ya
}, Symbol.toStringTag, { value: "Module" })), or = (n, e) => ({
  x: Math.min(n.x, e.x),
  y: Math.min(n.y, e.y),
...
const wd = /* @__PURE__ */ new Set(["varchar", "text", "markdown"]);
function _d(n) {
  return Object.entries(n ?? {}).filter(([e, t]) => !e.startsWith("_") && !e.startsWith("@") && typeof (t == null ? void 0 : t.type) == "string" && wd.has(t.type)).map(([e, t]) => ({
    attribute: e,
    ...typeof t.label == "string" ? { label: t.label } : {}
  }));
}
const lr = 1.25, Ed = 0.25, Sd = 8, cr = 4;
async function Md(n, e) {
  ...
  const t = e.object, s = e.targetFields ?? _d(((W = (T = t == null ? void 0 : t.model) == null ? void 0 : T.getAttributesDetails) == null ? void 0 : W.call(T)) ?? {}), r = qe(n, "bd-pdfregion");
  n.innerHTML = ee`
  ...
  const R = (I) => {
    ...
    if (!_)
      return;
    const F = or(_, R(I));
    if (_ = null, F.width < cr || F.height < cr) {
      x();
      return;
    }
    oe(gd(F, { width: M, height: b }));
  };
  ...
  const me = (I) => {
    ...
    F && (F.dataset.nav === "prev" ? J(w - 1) : F.dataset.nav === "next" ? J(w + 1) : F.dataset.zoom === "in" ? U($ * lr) : F.dataset.zoom === "out" ? U($ / lr) : F.dataset.zoom === "fit" && P && i.clientWidth && U(i.clientWidth / P));
  };
...
const Cd = () => import("./BDComments-f06007da.js").then((n) => n.f).then((n) => n.default), xd = "2.14.8";
typeof window < "u" && !window.BlitzUIManager && (window.BlitzUIManager = {
  default: ps,
  BlitzUIManagerExtended: hd,
  VERSION: xd,
  loadBDComments: Cd,
  ImageLightbox: md,
  openImageLightbox: ys,
  attachImageLightbox: ma,
  mountTransactionInspector: pa,
  addInspectorLink: ya,
  mountObjectHistory: kn,
  mountObjectHistoryModal: hs,
  mountPdfRegionEditor: Md,
  previousValueOf: ca,
  branchOf: la,
  html: ee,
  raw: se,
