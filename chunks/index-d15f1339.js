...
const Lc = ln(() => import("./index-5923a31f.js")), Dc = ln(() => import("./index-c88f3654.js")), Ac = {
  type: "phone",
  empty: (n) => !n,
...
function Zr(n) {
  ...
  n.registry.mergeBuiltin("duration", { editor: Ge(nt(() => import("./duration-05fed796.js"))) }), n.registry.mergeBuiltin("percentage", { editor: Ge(nt(() => import("./percentage-6b632520.js"))) }), n.registry.mergeBuiltin("tag", { editor: Ge(nt(() => import("./tag-025a3b13.js"))) }), n.registry.mergeBuiltin("youtube", { editor: Ge(nt(() => import("./youtube-46dcfc34.js"))) }), n.registry.mergeBuiltin("json", { editor: Ge(nt(() => import("./json-9c67133c.js"))) }), n.registry.mergeBuiltin("markdown", { editor: Ge(nt(() => import("./markdown-1a917f8b.js"))) }), n.registry.mergeBuiltin("code", { editor: Ge(nt(() => import("./code-63324754.js"))) });
}
...
class ps {
  ...
  constructor(e, t) {
    ...
    ne(this, "inputs", {
      ...
      textarea: Mt,
      number: ct,
      phone: ln(() => import("./index-5923a31f.js")),
      boolean: as,
      date: Kt,
      html: ln(() => import("./index-c88f3654.js")),
      image: Cn,
      video: ls,
      file: cs,
      pdf: Vr,
    ...
    ne(this, "editors", {
      ...
      htmlText: nt(() => import("./index-34149cdd.js")),
      varchar: vu,
      text: Qs,
      markdown: Qs,
      tag: Du,
      texti18n: Au,
      email: bu,
      phone: nt(() => import("./index-949f538c.js")),
      url: wu,
      youtube: Ou,
      int: Zs,
      tinyint: Zs,
...
const Sd = () => import("./BDComments-52e0288e.js").then((n) => n.f).then((n) => n.default), Md = "2.14.3";
